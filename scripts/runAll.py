...
getFasta.commandLine(genomeVers, chro, str(start), str(end), direc+"/"+outFile+".fa")
# wsl ./twoBitToFa mm9.2bit stdout -seq=chr17 -start=35641798 -end=35648906 > mm9_chr17_35641798_35648906.fa
crispordnld.crisporDownload(outFile+".fa", genomeName, direc+"/"+outFile, directory_path)
datafield=sgRNA_design.formatCSV(direc+"/"+outFile+".csv", tss, lb, ub, mit, doench, offtarget)
outFasta=geneName+"_best_sgRNA.fa"
createFasta.write(datafield, direc+"/"+outFasta)
